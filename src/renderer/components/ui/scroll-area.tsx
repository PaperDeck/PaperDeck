  ...
  return (
    ...
    >
      <ScrollAreaPrimitive.Viewport
        ...
        className="focus-visible:ring-ring/50 w-full h-full rounded-[inherit] transition-[color,box-shadow] outline-none overflow-auto focus-visible:ring-[3px] focus-visible:outline-1"
        ref={ref}
      >
        {children}
      </ScrollAreaPrimitive.Viewport>
    ...
    <ScrollAreaPrimitive.Scrollbar
      ...
      className={cn(
        "flex touch-none p-px select-none transition-opacity duration-300 " +
          "data-[state=hidden]:opacity-0 data-[state=visible]:opacity-80 " +
